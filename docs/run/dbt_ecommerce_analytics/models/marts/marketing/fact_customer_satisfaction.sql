    ...
    create or replace table `ecommerce-analytics-475706`.`dbt_ecommerce_mart`.`fact_customer_satisfaction`
...
reviews as (
    ...
    from `ecommerce-analytics-475706`.`dbt_ecommerce_staging`.`staging_order_reviews`
