    ...
    create or replace table `ecommerce-analytics-475706`.`dbt_ecommerce_mart`.`fact_customer_lifetime_value`
...
orders as (
    ...
    select * from `ecommerce-analytics-475706`.`dbt_ecommerce_core`.`fact_orders`
...
customers as (
    ...
    select * from `ecommerce-analytics-475706`.`dbt_ecommerce_core`.`dim_customers`
