  ...
  create or replace view `ecommerce-analytics-475706`.`dbt_ecommerce_staging`.`staging_geolocation`
  OPTIONS()
  as /*
...
source as (
    ...
    select *
    from `ecommerce-analytics-475706`.`dbt_ecommerce_raw`.`olist_geolocation_dataset`
